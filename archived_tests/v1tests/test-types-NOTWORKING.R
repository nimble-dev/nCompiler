# Testing nCompiler types.
# One expect_error test still errors out with the test not passing.
...
test_that("Trap error from type incompatible with default. (This should show a warning.)", {
  ## Error-trapping
