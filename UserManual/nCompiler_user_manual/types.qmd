...
- Types include basic types (scalars, vectors, matrices, or arrays of doubles, integers, or logicals), `nClass` types, `nCppVec` types, and `Rcpp` types, among others.
