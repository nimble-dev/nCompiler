#ifndef __OptimControlList_H_PREDEF
#define __OptimControlList_H_PREDEF
...
class OptimControlList : public genericInterfaceC<OptimControlList>, public loadedObjectHookC<OptimControlList> {
public:
  int trace;
  double fnscale;
