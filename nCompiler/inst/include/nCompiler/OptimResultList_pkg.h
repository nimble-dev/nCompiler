#ifndef __OptimResultList_H_PREDEF
#define __OptimResultList_H_PREDEF
...
class OptimResultList : public genericInterfaceC<OptimResultList>, public loadedObjectHookC<OptimResultList> {
public:
