...
#' 
#' Additionally, \code{returnType(eigenNimbleList())} can be used within a \link{nFunction} to specify that the function will return a \code{nCompilerList} generated by the \code{nimEigen} function.  \code{eigenNimbleList()} can also be used to define a nested \code{nimbleList} element.  See the User Manual for usage examples. 
#' 
#' @return
#' The spectral decomposition of \code{x} is returned as a \code{nCompilerList} with elements:
#' \itemize{
...
#' }
#' 
#' @seealso  \link{nimSvd} for singular value decompositions in nCompiler. 
#' 
#' @examples
...
#'  
#'  \code{returnType(svdNimbleList())} can be used within a \link{nFunction} to specify that the function will return a \code{nCompilerList} generated by the \code{nimSvd} function.  \code{svdNimbleList()} can also be used to define a nested \code{nimbleList} element.  See the User Manual for usage examples. 
#' 
#' @return
...
#' }
#' 
#' @seealso  \link{nimEigen} for spectral decompositions. 
#' @examples 
