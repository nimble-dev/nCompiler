...
##     }
##   )
##   expect_error(nCompile(nf1))
##   expect_error(nCompile(nf2))
##   expect_error(nCompile(nf3))
##   expect_error(nCompile(nf4))
##   expect_error(nCompile(nf5))
##   expect_error(nCompile(nf6))
##   expect_error(nCompile(nf7))
##   expect_error(nCompile(nf8))
##   expect_error(nCompile(nf9))
##   expect_error(nCompile(nf10))
## })
